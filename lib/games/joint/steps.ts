 ...
 * Total base: 11 * 60 = 660 — Total max (all fast): 11 * 160 = 1760
 */
export const WIN_SCORE: Record<DifficultyLevel, number> = {
  1: 550,   // just complete all steps, any speed
  2: 850,   // need ~2 speed bonuses
  3: 1150,  // need ~5 speed bonuses
  4: 1450,  // need ~8 speed bonuses
  5: 1700,  // need nearly all speed bonuses
};
